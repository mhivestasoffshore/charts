...
| `distributor.image.tag` | Docker tag for distributor | `1.4.1` |
...
| `ingester.image.tag` | Docker tag for ingester | `1.4.1` |
...
| `querier.image.tag` | Docker tag for querier | `1.4.1` |
...
| `query_frontend.image.tag` | Docker tag for query frontend | `1.4.1` |
...
| `table_manager.image.tag` | Docker tag for table manager | `1.4.1` |
